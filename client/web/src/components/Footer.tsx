...
import { Bug, Lightbulb, Mail, Github, MessageSquare, Box, Terminal, Cpu } from "lucide-react";
    ...
    <footer className="section-padding" style={{ borderTop: "1px solid var(--border-card)", padding: "60px 20px 40px", background: "var(--bg-card)" }}>
      <div style={{ maxWidth: "1340px", margin: "0 auto" }}>
        <div className="grid-footer" style={{ marginBottom: "48px" }}>
          <div>
            ...
            <p style={{ color: "var(--text-muted)", fontSize: "0.85rem", lineHeight: 1.6, marginBottom: "20px" }}>
              High-performance open-source in-memory database with Zero-OOM Tiered Spilling, Cosine Similarity AI Vector Search, and engine-level JSON schema validation.
            </p>
            <div style={{ display: "inline-flex", alignItems: "center", gap: "6px", padding: "4px 10px", borderRadius: "16px", background: "rgba(52, 211, 153, 0.1)", border: "1px solid rgba(52, 211, 153, 0.2)", fontSize: "0.78rem", color: "var(--accent-mint)" }}>
              ...
              <span>All Systems Operational (v0.1.2 Released)</span>
            </div>
          </div>
          ...
          <div>
            <h5 style={{ color: "var(--text-main)", fontSize: "0.88rem", fontWeight: 700, marginBottom: "16px" }}>Registries &amp; Docker</h5>
            <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: "10px", fontSize: "0.85rem", color: "var(--text-muted)" }}>
              <li>
                <a href="https://hub.docker.com/r/sanjoydb/sayodb-server" target="_blank" rel="noreferrer" style={{ color: "var(--accent-indigo)", textDecoration: "none", display: "flex", alignItems: "center", gap: "6px", fontWeight: 600 }}>
                  <Box size={13} />
                  <span>Docker Hub: Server</span>
                </a>
              </li>
              <li>
                <a href="https://hub.docker.com/r/sanjoydb/sayodb-gui" target="_blank" rel="noreferrer" style={{ color: "var(--accent-indigo)", textDecoration: "none", display: "flex", alignItems: "center", gap: "6px", fontWeight: 600 }}>
                  <Box size={13} />
                  <span>Docker Hub: Web GUI</span>
                </a>
              </li>
              <li>
                <a href="https://www.npmjs.com/package/@sayodb/client" target="_blank" rel="noreferrer" style={{ color: "var(--accent-mint)", textDecoration: "none", display: "flex", alignItems: "center", gap: "6px", fontWeight: 600 }}>
                  <Cpu size={13} />
                  <span>NPM: @sayodb/client</span>
                </a>
              </li>
              <li>
                <a href="https://www.npmjs.com/package/sayodb" target="_blank" rel="noreferrer" style={{ color: "var(--accent-mint)", textDecoration: "none", display: "flex", alignItems: "center", gap: "6px", fontWeight: 600 }}>
                  <Terminal size={13} />
          ...
          <div>
            ...
            <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: "10px", fontSize: "0.85rem", color: "var(--text-muted)" }}>
              <li>
                <a href="mailto:sanjoydeb404@gmail.com" style={{ color: "var(--accent-indigo)", textDecoration: "none", display: "flex", alignItems: "center", gap: "6px", fontWeight: 600 }}>
                  <Mail size={13} />
                  <span>Email Support</span>
                </a>
              </li>
              <li>
                <a href="https://github.com/sanjoy-ui" target="_blank" rel="noreferrer" style={{ color: "var(--text-muted)", textDecoration: "none", display: "flex", alignItems: "center", gap: "6px" }}>
                  <Github size={13} />
        ...
        <div style={{ paddingTop: "24px", borderTop: "1px solid var(--border-card)", display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: "0.82rem", color: "var(--text-dim)", flexWrap: "wrap", gap: "14px" }}>
          <div>© 2026 sayoDB Project. Open Source under MIT License.</div>
